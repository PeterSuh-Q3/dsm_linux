#pragma once
/* Fail-closed fallback when libhydrogen is unavailable */
#include <stddef.h>
#include <stdint.h>
...
static inline int hydro_sign_create(uint8_t *csig, const void *m, size_t mlen,
				     const char *ctx, const uint8_t *sk) { return -1; }
static inline int hydro_sign_init(void *state, const char *ctx) { return -1; }
static inline int hydro_sign_update(void *state, const void *m, size_t mlen) { return -1; }
