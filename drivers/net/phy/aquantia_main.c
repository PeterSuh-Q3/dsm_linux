...
#define VEND1_GLOBAL_LED_RX_ACTIVITY        BIT(3)
#define VEND1_GLOBAL_LED_TX_ACTIVITY        BIT(2)
#define VEND1_GLOBAL_LED_ACTIVITY           (( VEND1_GLOBAL_LED_RX_ACTIVITY | VEND1_GLOBAL_LED_TX_ACTIVITY ))

#define VEND1_GLOBAL_LED_LINK_UP_5G         BIT(15)
#define VEND1_GLOBAL_LED_LINK_UP_2500M      BIT(14)
#define VEND1_GLOBAL_LED_LINK_UP_10M        BIT(13)
#define VEND1_GLOBAL_LED_LINK_UP_10G        BIT(7)
#define VEND1_GLOBAL_LED_LINK_UP_1G         BIT(6)
#define VEND1_GLOBAL_LED_LINK_UP_100M       BIT(5)
#define VEND1_GLOBAL_LED_LINK_UP_ALL_SPD    (( VEND1_GLOBAL_LED_LINK_UP_5G | \
                                               VEND1_GLOBAL_LED_LINK_UP_2500M | \
                                               VEND1_GLOBAL_LED_LINK_UP_10M | \
                                               VEND1_GLOBAL_LED_LINK_UP_10G | \
                                               VEND1_GLOBAL_LED_LINK_UP_1G | \
                                               VEND1_GLOBAL_LED_LINK_UP_100M ))

#define VEND1_GLOBAL_LED_STRECH_100MS       0x3
...
static int syno_conf_init(struct phy_device *phydev)
{
	...
	if (!phydev) {
		phydev_err(phydev, "Invalid phydev\n");
		goto END;
	}

	/* LED0 => Speed LED */
	if (0 != (ret = phy_write_mmd(phydev, MDIO_MMD_VEND1, VEND1_GLOBAL_LED_PROVISIONING1, VEND1_GLOBAL_LED_LINK_UP_10G))) {
		phydev_err(phydev, "Failed to set speed led behavior\n");
		goto END;
	}
	...
	/* LED2 => Active LED */
	if (0 != (ret = phy_write_mmd(phydev, MDIO_MMD_VEND1, VEND1_GLOBAL_LED_PROVISIONING3, VEND1_GLOBAL_LED_LINK_UP_ALL_SPD | VEND1_GLOBAL_LED_ACTIVITY | VEND1_GLOBAL_LED_STRECH_100MS))) {
		phydev_err(phydev, "Failed to set active led behavior\n");
		goto END;
	}
